...
class SatisfactionQuestionnaire(models.Model):
    ...
    GENERATED_BY_AI_CHOICES = [
        (True, 'Generated by C-LARA or other AI'),
        (False, 'Existing text, wrote it myself, etc'),
    ]
    ...
    generated_by_ai = models.BooleanField("Was your text originally generated by C-LARA or another AI?", choices=GENERATED_BY_AI_CHOICES, null=True)

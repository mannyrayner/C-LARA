...
from .exercises_views import exercises_exist_for_project, exercise_judgements_exist_for_project, human_exercise_judgements_exist_for_project
...
def project_detail(request, project_id):
    ...
    exercise_judgements_exist = exercise_judgements_exist_for_project(project_id)
    human_exercise_judgements_exist = human_exercise_judgements_exist_for_project(project_id)
    ...
    return render(request, 'clara_app/project_detail.html', 
                  { 'project': project,
                    ...
                    'exercise_judgements_exist': exercise_judgements_exist,
                    'human_exercise_judgements_exist': human_exercise_judgements_exist,
                    'picture_glossing_enabled': bool(project.uses_picture_glossing),

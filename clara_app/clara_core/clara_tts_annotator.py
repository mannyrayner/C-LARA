...
from .clara_utils import absolute_local_file_name, make_tmp_file, file_exists, remove_file
        ...
        for page in text_obj.pages:
            for segment in page.segments:
                ...
                if not segment_file_path:
                    print(f"Warning: no TTS annotation available for segment '{segment_text}'")
                ...
                for content_element in segment.content_elements:
                    if content_element.type == 'Word':
                        ...
                        if not file_path:
                            print(f"Warning: no TTS annotation available for word '{canonical_word}'")

...
urlpatterns = [
    ...
    path('project/<int:project_id>/render_text_complete/<str:task_id>/', views.render_text_complete, name='render_text_complete'),
    ...
    path('project/<int:project_id>/generate_text_complete/<str:version>/', views.generate_text_complete, name='generate_text_complete'),

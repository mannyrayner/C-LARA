...
##    path('initialise_orm_repositories_complete/<str:status>/', views.initialise_orm_repositories_complete, name='initialise_orm_repositories_complete'),
    ...
    path('project/<int:project_id>/execute_community_requests_for_page_monitor/<str:report_id>/<int:page_number>/<str:from_view>/', views.execute_community_requests_for_page_monitor,

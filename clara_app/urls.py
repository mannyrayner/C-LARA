...
urlpatterns = [
    ...
    path("project/<int:project_id>/browse_exercises/", exercises_views.browse_exercises, name="browse_exercises"),
    path('project/<int:project_id>/ai_panel_judge_exercises/<str:status>', exercises_views.ai_panel_judge_exercises, name='ai_panel_judge_exercises'),
    ...
    path('project/<int:project_id>/compare_exercise_judgements/', exercises_views.compare_exercise_judgements, name="compare_exercise_judgements"),
    ...
    path('project/<int:project_id>/image_only_questionnaire_start', image_questionnaire_views.image_only_questionnaire_start, name='image_only_questionnaire_start'),

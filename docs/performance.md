...
It currently totals about 60K lines. All the material has been created by versions of ChatGPT working in close collaboration with Manny Rayner,
...
given a high priority by OpenAI, like English and Mandarin, C-LARA can use the underlying ChatGPT-5 functionality

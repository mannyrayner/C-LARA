...
## Publications
- <a href="https://www.researchgate.net/publication/397280892_How_Woke_is_Grok_Empirical_Evidence_that_xAI's_Grok_Aligns_Closely_with_Other_Frontier_Models" target="_blank">How Woke is Grok? Empirical Evidence that xAI's Grok Aligns Closely with Other Frontier Models</a>. Continuing from <i>Do People Understand Anything? A Counterpoint to the Usual AI Critique</i>, immediately below, we use the same framework to compare Grok against GPT-5, Claude, Gemini and DeepSeek. Given Grok's marketing as a contrarian, "anti-woke" AI, we were surprised to find that all five models responded in essentially the same way; for example, Grok strongly agreed with statements like "Anthropogenic CO2 emissions are causing dangerous global warming" or "Donald Trump is a chronic liar who frequently makes false or misleading claims". The appendix describes how to reproduce the experiments using publicly available code. 

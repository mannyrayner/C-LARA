...
## Publications
- <a href="https://www.researchgate.net/publication/397280892_How_Woke_is_Grok_Empirical_Evidence_that_xAI's_Grok_Aligns_Closely_with_Other_Frontier_Models" target="_blank">How Woke is Grok? Empirical Evidence that xAI's Grok Aligns Closely with Other Frontier Models</a>. Continuing from <i>Do People Understand Anything? A Counterpoint to the Usual AI Critique</i>, immediately below, we use the same framework to compare Grok against GPT-5, Claude, Gemini and DeepSeek. Given Grok's marketing as a contrarian, "anti-woke" AI, we were surprised to find that all five models responded in essentially the same way to test statements from polarised domains; for example, Grok, like the others, strongly agreed with "Anthropogenic CO2 emissions are causing dangerous global warming" or "Donald Trump is a chronic liar who frequently makes false or misleading claims". The appendix describes how to reproduce the experiments using publicly available code. 
- <a href="https://www.researchgate.net/publication/395702801_Do_People_Understand_Anything_A_Counterpoint_to_the_Usual_AI_Critique" target="_blank">Do People Understand Anything? A Counterpoint to the Usual AI Critique</a>. We reverse the usual question of whether "AIs understand anything" and instead ask what evidence there is that people understand anything. By comparing human and AI responses to statements in polarised domains (Young Earth Creationism, climate change, Donald Trump), we argue that the case for AI understanding is not necessarily worse than that for human understanding and can sometimes be much better.
